...
function MyVerticallyCenteredModal(props: any) {
  return (
    <Modal {...props} size='lg' aria-labelledby='contained-modal-title-vcenter' centered>
      ...
      <Modal.Body>
        <p>
          Проводите лучшие киберспортивные турниры у себя в вузе? Попробуйте показать себя на новом
          межуниверситетском уровне. Подавайте заявку к нам в команду.
        </p>
      </Modal.Body>
      <Modal.Footer>
        <Button href='https://forms.gle/xmpsEXUwEwLYBKp99' target='_blank'>
          Подать заявку
        </Button>
      ...
      >
        <div>
          <Card className='mt-5 p-1 card-primary'>
            ...
            <Card.Title style={{ color: '#f4f4f4', textAlign: 'center' }} className='card-title'>
              {gameTitle}
            </Card.Title>
          </Card>
        </div>
